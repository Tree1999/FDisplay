...
QT_EXT UINT8 init_touch_driver(UINT8 I2C_address, void (*handler)(UINT8 *, UINT8));
QT_EXT UINT8 close_touch_driver(void);
QT_EXT UINT8 get_variant_id(UINT8 *variant);
QT_EXT UINT8 get_family_id(UINT8 *family_id);
QT_EXT UINT8 get_build_number(UINT8 *build);
QT_EXT UINT8 get_version(UINT8 *version);

QT_EXT UINT8 get_object_size(UINT8 object_type);
QT_EXT UINT8 type_to_report_id(UINT8 object_type, UINT8 instance);
QT_EXT UINT8 report_id_to_type(UINT8 report_id, UINT8 *instance);
QT_EXT UINT8 read_id_block(info_id_t *id);
QT_EXT UINT8 get_max_report_id(void);
QT_EXT UINT16 get_object_address(UINT8 object_type, UINT8 instance);
QT_EXT UINT32 get_stored_infoblock_crc(void);
//QT_EXT UINT8 calculate_infoblock_crc(UINT32 *crc_pointer);
QT_EXT UINT32 CRC_24(UINT32 crc, UINT8 byte1, UINT8 byte2);

QT_EXT info_block_t info_block;
QT_EXT report_id_map_t *report_id_map;
QT_EXT int max_report_id ;
QT_EXT UINT8 max_message_length;
QT_EXT UINT16 message_processor_address;
QT_EXT UINT16 command_processor_address;
QT_EXT enum driver_setup_t driver_setup;
QT_EXT UINT8 msg[256];

/*! Touch device I2C Address */

QT_EXT UINT8 QT_i2c_address;
QT_EXT  UINT8 QT_i2c_boot_address;
// QT_EXT UINT8 chip_detected_flag;
...
QT_EXT void (*application_message_handler)(UINT8 *, UINT8);
QT_EXT void message_handler(UINT8 *msg, UINT8 length);

QT_EXT UINT8 init_touch_app(void);

QT_EXT UINT8 write_mem( UINT16 Address, UINT8 ByteCount, UINT8 *Data );
QT_EXT UINT8 read_mem( UINT16 Address, UINT8 ByteCount, UINT8 *Data );
QT_EXT UINT8 read_uint16_t( UINT16 Address, UINT16 *Data );

QT_EXT UINT8 ChangeLineStatus( void );
...
//*****************************************************************************
#if 0
QT_EXT void I2cStart(void);
QT_EXT void I2cStop(void);
QT_EXT UINT8 I2cTxByte( UINT8 TxData);
QT_EXT UINT8 I2cRxByte( UINT8 AckState );
#endif

QT_EXT unsigned char  TWI_Wait(void);
QT_EXT void Twi_SendStop(void);
QT_EXT void InitTwi(void);
QT_EXT UINT8 address_slave(void);
