...
int max_report_id ;
UINT8 max_message_length;
UINT16 message_processor_address;
...
//    unsigned short i;
    ...
    if(I2C_MasterReadWait(CTP_IC,i2c_addr,i2c_cmd->txbuf,i2c_cmd->txlen))
...
// THIERRY UINT8 ChangeLineStatus( void )
// THIERRY {
